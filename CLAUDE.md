...
This is a content repository containing curated learning resources—not a software project. It consists of markdown files organizing recommendations for books, articles, podcasts, videos, and (planned) papers.
...
- `Videos.md` - Conference talks and presentations

## Content Format

Resources follow this pattern:
- **[Title](URL)** - Author/Source. Brief description. (N highlights) - for articles/podcasts
- **[Title](URL)** - Author. Description. - for books/videos
